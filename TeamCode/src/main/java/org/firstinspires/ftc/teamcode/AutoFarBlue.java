...
@Autonomous(name = "07: AutoFarBlue", group = "Active")
public class AutoFarBlue extends OpMode {
    ...
    private final Pose scorePose = new Pose(57.52914285714286, 12.45599999999999, Math.toRadians(180));
    ...
    public static final Pose getPickUp3 = new Pose(10.657059, 34.558042, Math.toRadians(-180));
