...
/**
 * This is the LocalizationTest OpMode. This is basically just a simple drive
 * attached to a
 ...
 * a Vector that
 * empirically represents the direction your wheels actually prefer to go in,
 * allowing for
...
class CentripetalTuner extends OpMode {
    ...
    public void start() {
        follower.activateAllPIDFs();
        forwards = new Path(new BezierCurve(new Pose(72, 72), new Pose(Math.abs(DISTANCE) + 72, 72),
                new Pose(Math.abs(DISTANCE) + 72, DISTANCE + 72)));
        backwards = new Path(new BezierCurve(new Pose(Math.abs(DISTANCE) + 72, DISTANCE + 72),
                new Pose(Math.abs(DISTANCE) + 72, 72), new Pose(72, 72)));
...
class Circle extends OpMode {
    ...
    public void start() {
        circle = follower.pathBuilder()
                .addPath(new BezierCurve(new Pose(72, 72), new Pose(RADIUS + 72, 72),
                        new Pose(RADIUS + 72, RADIUS + 72)))
                .setHeadingInterpolation(HeadingInterpolator.facingPoint(72, RADIUS + 72))
                .addPath(new BezierCurve(new Pose(RADIUS + 72, RADIUS + 72), new Pose(RADIUS + 72, (2 * RADIUS) + 72),
                        new Pose(72, (2 * RADIUS) + 72)))
                .setHeadingInterpolation(HeadingInterpolator.facingPoint(72, RADIUS + 72))
                .addPath(new BezierCurve(new Pose(72, (2 * RADIUS) + 72), new Pose(-RADIUS + 72, (2 * RADIUS) + 72),
                        new Pose(-RADIUS + 72, RADIUS + 72)))
                .setHeadingInterpolation(HeadingInterpolator.facingPoint(72, RADIUS + 72))
                .addPath(new BezierCurve(new Pose(-RADIUS + 72, RADIUS + 72), new Pose(-RADIUS + 72, 72),
                        new Pose(72, 72)))
                .setHeadingInterpolation(HeadingInterpolator.facingPoint(72, RADIUS + 72))
                .build();
 ...
 * You should use this to check how good your swerve angle offsets are and if
 * your motor directions are correct
 * 
 * @author Kabir Goyal
 *
 */
...
/**
 * This is the OffsetsTuner OpMode. This tracks the movement of the robot as it
 * turns 180 degrees,
 * and calculates what the robot's strafeX and forwardY offsets should be.
 * Ensure that your strafeX and forwardY offsets
 * are set to 0 before running this OpMode. After running, input the displayed
