...
public class AutonomieRed extends OpMode {
    ...
    private final Pose openGate = new Pose(127.4, 73.0696, Math.toRadians(0));

    // Pickup 2
    private final Pose pickup2 = new Pose(97.4890, 57.445, Math.toRadians(0));
    private final Pose getPick2 = new Pose(134.6529, 55.5345, Math.toRadians(0));
    ...
    private final Pose getPick3 = new Pose(134.1922, 33.2580, Math.toRadians(0));
