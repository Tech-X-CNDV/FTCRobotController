...
public class FieldPoses {
    ...
    public static final Pose OPEN_GATE = new Pose(16.5, 74.0695589, Math.toRadians(-177));
    ...
    public static final Pose GET_PICK_3 = new Pose(10.547059, 33.558042, Math.toRadians(-177));
