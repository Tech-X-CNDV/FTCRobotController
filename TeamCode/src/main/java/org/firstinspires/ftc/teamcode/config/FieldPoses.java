...
public class FieldPoses {
    ...
    public static final Pose SCORE = new Pose(55.13944285714287, 80.3317188, Math.toRadians(-177));
    public static final Pose SCORE_FINAL = new Pose(49.13944285714287, 100, Math.toRadians(143));
    ...
    public static final Pose GET_PICK_2 = new Pose(14.057059, 56.334464, Math.toRadians(-177));
    ...
    public static final Pose cycle = new Pose(10, 56, Math.toRadians(139));
    public static final Pose cycle2 = new Pose(10.1, 53.5, Math.toRadians(147));
