...
public class FieldPoses {
    ...
    public static final Pose OPEN_GATE = new Pose(16.5, 75.0695589, Math.toRadians(-177));

    // Pickup 2
    public static final Pose PICKUP_2 = new Pose(46.5110334, 57.334464, Math.toRadians(-177));
    public static final Pose GET_PICK_2 = new Pose(10.447059, 56.334464, Math.toRadians(-177));
    ...
    public static final Pose GET_PICK_3 = new Pose(10.77840, 33.558042, Math.toRadians(-177));
