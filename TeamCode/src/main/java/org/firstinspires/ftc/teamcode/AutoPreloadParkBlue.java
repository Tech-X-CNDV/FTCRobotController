...
public class AutoPreloadParkBlue extends OpMode {
    ...
    // Constant Poses
    private final Pose startPose = new Pose(59.52914285714286, 11.45599999999999, Math.toRadians(90));
    private final Pose LOCK_POSE = FieldPoses.LOCK_POSE;
    private final Pose parkPose = new Pose(35.829714285714275, 13.630857142857149, Math.toRadians(90));
