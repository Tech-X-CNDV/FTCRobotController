...
@Autonomous(name = "01: AutoRedV2", group = "Active")
public class AutonomieRedV2 extends OpMode {
    ...
    private final Pose cycle = FieldPoses.cycle.mirror();
    private final Pose cycle2 = FieldPoses.cycle2.mirror();
