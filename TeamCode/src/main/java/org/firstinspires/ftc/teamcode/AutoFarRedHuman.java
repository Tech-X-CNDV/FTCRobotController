...
public class AutoFarRedHuman extends OpMode {
    ...
    private final Pose getPickUp3 = FieldPoses.GET_PICK_3.mirror();

    private final Pose humanPickUp = new Pose(10.657059, 13.630857142857149, Math.toRadians(180)).mirror();
    ...
    public void init() {
        ...
        pickup3.setHeading(0);
        getPickUp3.setHeading(0);
        buildPaths();
